...
int ORBmatcher::ObjectSearchByBoW(KeyFrame* pKF,Frame &F, vector<MapPoint*> &vpMapPointMatches, std::map<int,int> &matches)
{
...
int ORBmatcher::ObjectSearchByProjection(Frame &CurrentFrame, const Frame &LastFrame, const float th, const bool bMono, std::map<int,int> &matches)
{
    int nmatches = 0;
