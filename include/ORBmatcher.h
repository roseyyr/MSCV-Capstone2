...
public:
    ...
    vector<int> ORBmatcher::CheckProjectionAfterPose(Frame &CurrentFrame, const Frame &ReferenceFrame, int obj_index, std::map<int,int> &matches, const float th, const bool bMono)
